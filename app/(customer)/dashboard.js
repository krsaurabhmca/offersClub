        ...
        if (data?.screen) {
          ...
          switch (data.type) {
            case "signup":
              ...
              break;
            case "share":
              router.push("/ShareAndEarnScreen");
              break;
            case "transaction":
  ...
  const handleWithdrawRequest = async () => {
    ...
    if (walletAmount < 50) {
      Alert.alert(
        ...
        `Minimum ₹50 required for withdrawal. Your current balance is ${formatCurrency(
          walletAmount
        )}.`,
        [{ text: "OK" }]
      );
      ...
      [
        {
          ...
          style: "cancel",
          onPress: () => {
            setWithdrawLoading(false); // Reset loading on cancel
          },
        },
        {
        ...
        onPress={async () => {
          if (!notificationPermission) {
            ...
            if (result) {
              Alert.alert(
                "Success",
                "Notifications enabled! You will now receive updates about offers and transactions."
              );
            }
          } else {
            Alert.alert(
              "Notifications",
              "Push notifications are already enabled for this app."
            );
          }
        }}
      />
  ...
  const CategoryItem = ({ category }) => (
    ...
    >
      <View style={styles.categoryIconContainer}>
        <Ionicons name={category.icon} size={24} color="#5f259f" />
      </View>
      ...
      <View style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push("/ShareAndEarnScreen")}
          >
      ...
      >
        ...
        <View style={styles.walletCard}>
              ...
              <View style={styles.walletStatus}>
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        userProfile.status === "ACTIVE" ? "#00C851" : "#ff4757",
                    },
                  ]}
                />
          ...
          <TouchableOpacity
            ...
            disabled={
              withdrawLoading || parseFloat(userProfile.wallet || 0) < 50
            }
            activeOpacity={0.8}
          >
            {withdrawLoading ? (
            ...
            <View style={styles.transactionBreakdown}>
              <View style={styles.breakdownItem}>
                <View style={styles.breakdownIndicator}>
                  <View
                    style={[styles.statusDot, { backgroundColor: "#00C851" }]}
                  />
              ...
              <View style={styles.breakdownItem}>
                ...
                <View style={styles.breakdownValues}>
                  <Text style={styles.breakdownAmount}>
                    {formatCurrency(
                      dashboardData.transactions.summary.total_pending_amount
                    )}
                  </Text>
                  <Text style={styles.breakdownCount}>
        ...
        <View style={styles.businessCard}>
          ...
          <View style={styles.businessServices}>
            ...
            >
              ...
              <View style={styles.businessServiceContent}>
                ...
                <Text style={styles.businessServiceSubtitle}>
                  Scan merchant QR codes for instant payments
                </Text>
              </View>
            ...
            >
              ...
              <View style={styles.businessServiceContent}>
                <Text style={styles.businessServiceTitle}>
                  Find Nearby Merchants
                </Text>
                <Text style={styles.businessServiceSubtitle}>
                  Discover merchants and stores around you
                </Text>
              </View>
              <Ionicons name="chevron-forward" size={20} color="#ccc" />
            </TouchableOpacity>
            ...
            >
              ...
              <View style={styles.businessServiceContent}>
                <Text style={styles.businessServiceTitle}>Help & Support </Text>
                <Text style={styles.businessServiceSubtitle}>
