      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalText}>
            You are about to delete your profile information. This action cannot
            be undone.
          </Text>
          ...
          <View style={styles.riskContainer}>
            ...
            <View style={styles.riskItem}>
              ...
              <Text style={styles.riskText}>
                Your bank account details will be removed
              </Text>
            </View>
            <View style={styles.riskItem}>
              <Ionicons name="remove-circle" size={16} color="#FF3B30" />
              <Text style={styles.riskText}>
                Payment services may be disrupted
              </Text>
            </View>
            <View style={styles.riskItem}>
              <Ionicons name="remove-circle" size={16} color="#FF3B30" />
          ...
          <View style={styles.modalButtonRow}>
            ...
            <TouchableOpacity
              style={[
                ...
                confirmText !== confirmationKeyword &&
      ...
      >
          ...
          <View style={styles.userStats}>
            <View style={styles.statItem}>
              <Text style={styles.statValue}>
                ₹{parseFloat(userProfile.wallet || 0).toFixed(2)}
              </Text>
        ...
        <View style={styles.dangerZone}>
          ...
          <Text style={styles.dangerZoneDescription}>
            This will permanently delete your all account information from our
            system.
          </Text>
        </View>
